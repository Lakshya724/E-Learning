  ...
  return (
    <div className="bg-gray-100">
      ...
      <div
        ...
        style={{ backgroundImage: "url('/src/assets/Mobile.jpg')" }}
      >
      ...
      <div className="text-center mt-6">
        <h3 className="text-lg font-bold">All the skills related to App Development...</h3>
      </div>

      {/* Filter Buttons */}
      <div className="flex justify-center space-x-4 my-6">
        {["SWIFT", "FLUTTER", "ANDROID", "REACT-NATIVE"].map((tech, index) => (
      ...
      <div className="bg-[#7a739d] text-white text-center py-4">
