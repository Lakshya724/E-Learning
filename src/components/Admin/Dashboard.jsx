      ...
      <div className="ml-64 p-6 w-full">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-6">
          {["Total Users", "Monthly Users", "Daily Users"].map((title, index) => (
            <div key={index} className="bg-blue-500 text-white p-6 rounded-lg shadow-md text-center font-bold text-lg">
              {title}
            </div>
          ))}
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="bg-white p-6 rounded-lg shadow-md">
            ...
            <ResponsiveContainer width="100%" height={300}>
              <PieChart>
                <Pie data={userDistributionData} dataKey="value" nameKey="name" cx="50%" cy="50%" outerRadius={100}>
